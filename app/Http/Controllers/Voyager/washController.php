...
class washController extends \TCG\Voyager\Http\Controllers\Controller
{
   ...
   public function show(Request $request, $id)
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allLaundries','allCategories','allBusiness','allBanners','CategoriesForLaundry','laundry','banners'));
    }
    // POST BR(E)AD
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            CategoryLaundry::where('laundry_id', $id)->delete();

            //re insert if atleast one category is checked//
            if($request->category){
                foreach ($request->category as $category)
                    CategoryLaundry::create([
                        'laundry_id' => $id,
    ...
    public function create(Request $request)
    {
       ...
       $allCategories= Category::all();
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allLaundries','allCategories','allBusiness','allBanners','BusinessForLaundry','CategoriesForLaundry','CoordsForLaundry'));
    }
    /**
